...
m.def("Accent_r"     ,&cppcolormap::Accent_r     ,"Accent  - colorbrewer2.org",py::arg("N")= 8);
m.def("Dark2_r"      ,&cppcolormap::Dark2_r      ,"Dark2   - colorbrewer2.org",py::arg("N")= 8);
m.def("Paired_r"     ,&cppcolormap::Paired_r     ,"Paired  - colorbrewer2.org",py::arg("N")=12);
m.def("Spectral_r"   ,&cppcolormap::Spectral_r   ,"Spectra - colorbrewer2.org",py::arg("N")=11);
m.def("Pastel1_r"    ,&cppcolormap::Pastel1_r    ,"Pastel1 - colorbrewer2.org",py::arg("N")= 9);
m.def("Pastel2_r"    ,&cppcolormap::Pastel2_r    ,"Pastel2 - colorbrewer2.org",py::arg("N")= 8);
m.def("Set1_r"       ,&cppcolormap::Set1_r       ,"Set1    - colorbrewer2.org",py::arg("N")= 9);
m.def("Set2_r"       ,&cppcolormap::Set2_r       ,"Set2    - colorbrewer2.org",py::arg("N")= 8);
m.def("Set3_r"       ,&cppcolormap::Set3_r       ,"Set3    - colorbrewer2.org",py::arg("N")=12);
m.def("Blues_r"      ,&cppcolormap::Blues_r      ,"Blues   - colorbrewer2.org",py::arg("N")= 9);
m.def("Greens_r"     ,&cppcolormap::Greens_r     ,"Greens  - colorbrewer2.org",py::arg("N")= 9);
m.def("Greys_r"      ,&cppcolormap::Greys_r      ,"Greys   - colorbrewer2.org",py::arg("N")= 2);
m.def("Oranges_r"    ,&cppcolormap::Oranges_r    ,"Oranges - colorbrewer2.org",py::arg("N")= 9);
m.def("Purples_r"    ,&cppcolormap::Purples_r    ,"Purples - colorbrewer2.org",py::arg("N")= 9);
m.def("Reds_r"       ,&cppcolormap::Reds_r       ,"Reds    - colorbrewer2.org",py::arg("N")= 9);
m.def("BuPu_r"       ,&cppcolormap::BuPu_r       ,"BuPu    - colorbrewer2.org",py::arg("N")= 9);
m.def("GnBu_r"       ,&cppcolormap::GnBu_r       ,"GnBu    - colorbrewer2.org",py::arg("N")= 9);
m.def("PuBu_r"       ,&cppcolormap::PuBu_r       ,"PuBu    - colorbrewer2.org",py::arg("N")= 9);
m.def("PuBuGn_r"     ,&cppcolormap::PuBuGn_r     ,"PuBuGn  - colorbrewer2.org",py::arg("N")= 9);
m.def("PuRd_r"       ,&cppcolormap::PuRd_r       ,"PuRd    - colorbrewer2.org",py::arg("N")= 9);
m.def("RdPu_r"       ,&cppcolormap::RdPu_r       ,"RdPu    - colorbrewer2.org",py::arg("N")= 9);
m.def("OrRd_r"       ,&cppcolormap::OrRd_r       ,"OrRd    - colorbrewer2.org",py::arg("N")= 9);
m.def("RdOrYl_r"     ,&cppcolormap::RdOrYl_r     ,"RdOrYl  - colorbrewer2.org",py::arg("N")= 9);
m.def("YlGn_r"       ,&cppcolormap::YlGn_r       ,"YlGn    - colorbrewer2.org",py::arg("N")= 9);
m.def("YlGnBu_r"     ,&cppcolormap::YlGnBu_r     ,"YlGnBu  - colorbrewer2.org",py::arg("N")= 9);
m.def("YlOrRd_r"     ,&cppcolormap::YlOrRd_r     ,"YlOrRd  - colorbrewer2.org",py::arg("N")= 9);
m.def("BrBG_r"       ,&cppcolormap::BrBG_r       ,"BrBG    - colorbrewer2.org",py::arg("N")=11);
m.def("PuOr_r"       ,&cppcolormap::PuOr_r       ,"PuOr    - colorbrewer2.org",py::arg("N")=11);
m.def("RdBu_r"       ,&cppcolormap::RdBu_r       ,"RdBu    - colorbrewer2.org",py::arg("N")=11);
m.def("RdGy_r"       ,&cppcolormap::RdGy_r       ,"RdGy    - colorbrewer2.org",py::arg("N")=11);
m.def("RdYlBu_r"     ,&cppcolormap::RdYlBu_r     ,"RdYlBu  - colorbrewer2.org",py::arg("N")=11);
m.def("RdYlGn_r"     ,&cppcolormap::RdYlGn_r     ,"RdYlGn  - colorbrewer2.org",py::arg("N")=11);
m.def("PiYG_r"       ,&cppcolormap::PiYG_r       ,"PiYG    - colorbrewer2.org",py::arg("N")=11);
m.def("PRGn_r"       ,&cppcolormap::PRGn_r       ,"PRGn    - colorbrewer2.org",py::arg("N")=11);
