...
m.def("terrain", &cppcolormap::terrain, "terrain - matplotlib", py::arg("N")=256);
m.def("seismic", &cppcolormap::seismic, "seismic - matplotlib", py::arg("N")=256);
...
m.def("terrain_r", &cppcolormap::terrain_r, "terrain_r - matplotlib", py::arg("N")=256);
m.def("seismic_r", &cppcolormap::seismic_r, "seismic_r - matplotlib", py::arg("N")=256);
